const data = [
  {
    ...
    desc: "Suggest solutions for entreprises to better handle their projects and reduce the risks.",
  },
  {
    id: 2,
    image: "https://img.icons8.com/ios/40/000000/open-book.png",
    title: "App / Website Development",
    desc: "Develop applications to allow entreprises to have a better way of asisting to the clients needs or theirs.",
  },
  {
    id: 3,
    image:
    ...
    desc: "Empower entreprises with the abilities to host and safen their data in the cloud.",
  },
  /*{
    id: 4,
